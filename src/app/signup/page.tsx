        ...
        <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2 mx-auto mt-20">
            <div className="glass p-8 rounded-2xl border border-white/10 shadow-2xl">
                <div className="mb-8">
                    ...
                    <p className="text-zinc-400 text-sm mt-1">Join technews26 for exclusive hardware insights</p>
                </div>

                <form className="flex-1 flex flex-col w-full justify-center gap-4 text-zinc-300" action={signup}>
                    <div className="flex flex-col gap-1">
                        <label className="text-xs font-semibold text-zinc-400 uppercase tracking-widest" htmlFor="name">
                            Full Name
                        </label>
                        <input
                    ...
                    <div className="flex flex-col gap-1 mb-2">
                        ...
                        <input
                            ...
                            minLength={8}
                        />
                        <p className="text-[10px] text-zinc-500 mt-1">Must be at least 8 characters</p>
                    </div>
